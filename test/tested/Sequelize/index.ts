...
import Token, { TokenI, TokenType } from './models/Token';
...
/**
 * @exports Token - O modelo Token.
 * @exports TokenI - A interface TokenI.
 * @exports TokenType - O type do TokenType.
 * 
 * [Index gerada pelo sequelize-TS-Gerator](https://github.com/drylian/SequelizeTS-Gerador).
 */
export { Token, TokenI, TokenType };
...
/**
   * @function sync
   * @memberof Token
   * @description Sincroniza o modelo Token com a base de dados.
   * 
   * [Index gerados pelo sequelize-TS-Gerator](https://github.com/drylian/SequelizeTS-Gerador).
   */
  await Token.sync()
